...
<CardGrid>
	<Card title="迁移心智" icon="right-arrow">
		[从 Windows 切到 macOS](#1-从-windows-切到-macos)，先改掉最容易别扭的习惯。
	</Card>
	<Card title="系统模型" icon="setting">
		[理解应用、窗口、菜单栏、Dock、Spotlight](#2-macos-心智模型)，Mac 才会顺手。
	</Card>
	<Card title="快捷键" icon="document">
		[先学高频场景](#3-快捷键基础)，不要背快捷键大全。
	</Card>
	<Card title="日常效率" icon="window">
		[Finder、窗口、Spotlight、截图和输入](#4-日常效率)，解决每天都遇到的问题。
	</Card>
	<Card title="开发与 AI" icon="code-branch">
		[终端、Git、SSH、AI Coding](#5-终端开发与-ai-coding)，让 AI 正确理解项目。
	</Card>
	<Card title="工具与排障" icon="question-circle">
		[软件选择和常见问题](#6-软件选择与常见问题)，只在系统能力不够时加工具。
	</Card>
</CardGrid>
